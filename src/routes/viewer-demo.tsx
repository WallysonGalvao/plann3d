      ...
      <header className="h-16 border-b border-[#232f48] bg-[#111722] flex items-center justify-between px-6 lg:px-10 shrink-0 z-50 relative shadow-lg">
        ...
        <nav className="flex items-center gap-8">
          <div className="hidden md:flex items-center gap-8">
            <Link to="/" className="text-gray-300 hover:text-white text-sm font-bold leading-normal tracking-wide transition-colors">
              PROJETOS
            </Link>
            <a href="/#about" className="text-gray-300 hover:text-white text-sm font-bold leading-normal tracking-wide transition-colors">
              SOBRE
            </a>
            <Link to="/contact" className="text-gray-300 hover:text-white text-sm font-bold leading-normal tracking-wide transition-colors">
              CONTATO
            </Link>
          </div>
          <div className="h-6 w-px bg-[#232f48] hidden md:block" />
        ...
        <div className="absolute top-6 left-6 z-20 flex flex-col gap-2 max-w-lg animate-fade-in">
          <div className="glass-panel p-6 rounded-xl shadow-2xl">
            ...
            <h1 className="text-white text-4xl font-bold leading-tight tracking-tight mb-2">
              {selectedModel.name} <span className="text-gray-500 font-light">| 3D Viewer</span>
            </h1>
            <p className="text-gray-300 text-sm mb-4">
              {selectedModel.description}
            </p>
            <div className="flex items-center gap-4 text-xs text-gray-400 font-mono">
              <span>Ref: PROT-{selectedModel.id.toUpperCase()}-001</span>
              <span className="w-px h-3 bg-gray-700" />
              <span>Versão: 3.1 Rev B</span>
            </div>
          </div>
        </div>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-2 p-3 bg-[#1e293b] rounded-lg border border-[#232f48]">
                ...
                <span className="text-lg font-bold text-white">320 m²</span>
                <span className="text-xs text-gray-500">Piso térreo: 180m², Superior: 140m²</span>
              </div>
              <div className="flex flex-col gap-2 p-3 bg-[#1e293b] rounded-lg border border-[#232f48]">
                <span className="text-xs text-gray-400 uppercase font-mono tracking-wider">
                  Dimensões Base
                </span>
                <span className="text-lg font-bold text-white">12m x 15m</span>
                <span className="text-xs text-gray-500">Excluindo balanços e varandas</span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 bg-[#1e293b] rounded-lg border border-[#232f48]">
                  <div className="flex items-center gap-2 mb-2">
                    <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4h16v16H4z" />
                    </svg>
                    <h5 className="text-sm font-bold text-white">Pisos Internos</h5>
                  </div>
                  <p className="text-gray-300 text-xs leading-relaxed">
                    Porcelanato cinza claro 90x90cm (sala, cozinha), Vinílico (quartos).
                  </p>
                </div>
                <div className="p-3 bg-[#1e293b] rounded-lg border border-[#232f48]">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h5 className="text-sm font-bold text-white">Acabamento Fachada</h5>
                  </div>
                  <p className="text-gray-300 text-xs leading-relaxed">
                    Reboco liso com pintura acrílica branca, detalhes em ripado de madeira.
                  </p>
                </div>
              </div>
            </div>
