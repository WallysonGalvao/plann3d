...
import { fadeInLeft, formFieldVariants, staggerContainer } from '@/lib/motion-variants'
            ...
            >
              ...
              <div className="text-center lg:text-left mb-8">
                <h2 className="text-2xl font-semibold mb-2">
                  <span className="font-serif italic font-normal text-muted-foreground">
                    {t('contactPage.form.headerTitle').split(' ')[0]}
                  </span>{' '}
                  {t('contactPage.form.headerTitle').split(' ').slice(1).join(' ')}
                </h2>
